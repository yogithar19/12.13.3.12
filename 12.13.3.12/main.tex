...
p&=p_X=\text{Probability of getting tails in a toss}\\
&=\frac{1}{2}\\
...
\begin{align}
E\brak{X}&=\sum\limits^{3}_{k=0}k\binom{3}{k}p^kq^{3-k}\\
&=\frac{3}{2}\\
E\brak{X^2}&=\sum\limits^{3}_{k=0}k^2 p_X\brak{k}\\
&=3\\
\sigma_X&=\sqrt{3-\frac{3}{2}^2}\\
&=\sqrt{\frac{3}{4}}
\end{align}
\end{document}
